 ...
 * @author tu090
 */
public class bai12_JF_TinhLaiXuat extends javax.swing.JFrame {

    /**
     * Creates new form bai12_JF_TinhLaiXuat
     */
    public bai12_JF_TinhLaiXuat() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Lai xuat");

        jLabel1.setText("jLabel1");

        jLabel2.setText("Tien gui");
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGap(27, 27, 27)
                                        .addComponent(txt_Lai, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(jLabel2)
                                        .addGap(27, 27, 27)
                                        .addComponent(txt_Gui, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(jLabel4)
                                        .addGap(27, 27, 27)
                                        .addComponent(txt_Nam, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(18, 18, 18)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bai12_JF_TinhLaiXuat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new bai12_JF_TinhLaiXuat().setVisible(true);
            }
        });
    }
